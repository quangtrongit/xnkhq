...
<div class="wap_item video">
	...
	?>
        <div class="item">
            <div class="sp_img"><a class="xem_video" href="<?=$id_video?>" title="<?=$product[$i]['ten']?>">
            <img src="http://img.youtube.com/vi/<?=$id_video?>/0.jpg" alt="<?=$product[$i]['ten']?>" /></a></div>
            <h3 class="sp_name"><a class="xem_video" href="<?=$id_video?>" title="<?=$product[$i]['ten']?>"><?=$product[$i]['ten']?></a></h3>
        </div><!---END .item-->
    <?php } ?>
<div class="clear"></div>
