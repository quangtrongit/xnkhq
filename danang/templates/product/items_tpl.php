...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <tr>
        ...
        <td class="tb_data_small <?=(!$config_s['danhmuc'])?'none':''?>"><?=get_main_danhmuc()?></td>
        <td class="tb_data_small <?=(!$config_s['list'])?'none':''?>"><?=get_main_list()?></td>
        <td class="tb_data_small <?=(!$config_s['cat'])?'none':''?>"><?=get_main_category()?></td>
        <td class="tb_data_small none"><?=get_main_item()?></td>
        <td class="sortCol"><div>Tên sản phẩm<span></span></div></td>
        <td class="sortCol " width="10%" ><div>Lượt xem <span></span></div></td>
        ...
        <td class="tb_data_small <?=(!$config_s['url'])?'none':''?>">Link</td>
    ...
    <tbody>
        ...
        <td align="center" class="<?=(!$config_s['danhmuc'])?'none':''?>">
			<?php
		...
		<td align="center" class="<?=(!$config_s['list'])?'none':''?>">
			<?php
			...
			?>      
                ...
                <td align="center" class="<?=(!$config_s['cat'])?'none':''?>">
			<?php
        ...
        <td class="title_name_data" align="center"><?=$items[$i]['luotxem']?></td>
        ...
        <td align="center" class="<?=(!$config_s['url'])?'none':''?>">
       		<a href="<?=$web.$com.'/'.$items[$i]['tenkhongdau'].$duoi ?>" target="_blank" class="button blueB" style="border: none;">Xem</a> 
       	</td>
        <td class="actBtns">
