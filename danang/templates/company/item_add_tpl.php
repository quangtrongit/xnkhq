    ...
    <div class="title"><img src="./images/icons/dark/users.png" alt="" class="titleIcon" />
       ...
       <?php foreach ($config['lang'] as $key => $value) { ?>
        ...
        <div class="formRow none">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['diachi2'.$key]?>" name="diachi2<?=$key?>" title="Nhập địa chỉ công ty" class="tipS" onblur="showAddress(this.value);" />
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow none">
			<label>Sologan </label>
			<div class="formRight">
				<input type="text" value="<?=@$item['slogan'.$key]?>" name="slogan<?=$key?>" title="Nhập địa chỉ công ty" class="tipS" onblur="showAddress(this.value);" />
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['dienthoai']?>" name="dienthoai<?=$key?>" title="Nhập số điện thoại" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		</div>
       <?php } ?>
        ...
        <div class="formRow">
			<label>Email 2</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['email2']?>" name="email2" title="Nhập địa chỉ email" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
        ...
        <div class="formRow none">
			<label>Fax</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['fax']?>" name="fax" title="Nhập số điện thoại" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>  
        <div class="formRow">
        ...
        <div class="formRow">
		 ...
		 <div class="formRow ">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['ngaylamviec']?>" name="ngaylamviec" title="Nhập Ngày làm việc" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
	 ...
	 <div class="widget">
        ...
        <div class="formRow none">
         ...
         <div class="formRow none">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['facebook']?>" name="facebook" title="Nhập địa chỉ instagrams" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow ">
        ...
        <div class="formRow none">
         ...
         <div class="formRow none">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['skype']?>" name="skype" title="Nhập địa instagram" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
         <div class="formRow none">
			<label>Rss</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['yahoo']?>" name="yahoo" title="Nhập địa chỉ rss" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
        ...
        <div class="formRow ">
			<label>Zalo</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['zalo']?>" name="zalo" title="Nhập link zalo page" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
     </div>
     ...
     <div class="widget">
      ...
      <div class="formRight">
		...
		<div class="formRow">
			...
			<div class="formRight">
                <textarea rows="4" cols="" title="Nhập Link google map. " class="tipS" name="link_googlemap"><?=@$item['link_googlemap']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
