  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <td class="sortCol <?= (!$config_s['luotxem'])?'none':'' ?>" width="10%" ><div>Lượt xem <span></span></div></td>
    ...
    <tbody>
       ...
       <td>
		...
		<td class="title_name_data <?= (!$config_s['luotxem'])?'none':'' ?>" align="center"><?=$items[$i]['luotxem']?></td>
