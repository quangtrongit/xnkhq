...
function save_item(){
	...
	if($id){
		...
		$data['tenkhongdau'] = (!empty($_POST['link_url']))?trim($_POST['link_url']):changeTitle($_POST['ten']);			
		...
		if($d->update($data))
		{
			...
			transfer("Lưu dữ liệu thành công","index.php?com=product&act=man".$urlcu);
		}
		else
...
function save_list(){
	...
	if($id){		
		...
		$d->setWhere('id', $id);
		if($d->update($data))
			transfer("Lưu dữ liệu thành công","index.php?com=product&act=man_list".$urlcu);
		else
...
function save_danhmuc(){
	...
	if($id){		
		...
		$d->setWhere('id', $id);
		if($d->update($data))
			transfer("Lưu dữ liệu thành công","index.php?com=product&act=man_danhmuc".$urlcu);
		else
